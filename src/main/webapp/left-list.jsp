...
<div class="sidenav">
	...
	<c:url var="classesLink" value="adminController">
		<c:param name="command" value="CLASSES" />
	</c:url>

	<c:url var="subjectsLink" value="adminController">
		<c:param name="command" value="SUBJECTS" />
	</c:url>

	<c:url var="teachersLink" value="adminController">
		<c:param name="command" value="TEACHERS" />
	</c:url>

	<c:url var="studentsLink" value="adminController">
